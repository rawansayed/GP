...
import pandas as pd
import numpy as np
X=np.load('./TrainingAutoEncoder/eg_1_cls_on_target.episgt.npy', allow_pickle=True)
...
model=model.load("./TrainingAutoEncoder/model.tfl")
...
df.to_csv("./TrainingAutoEncoder/filename.csv")