...
def scenario6(epochNum):
    # --------------- loading Data --------------- #
    files = ['hek293t.episgt','hct116.episgt','hl60.episgt']
    ...
    dataArr_inputs_train_hela=np.load(f"./training_data/inputs_hela_REG.npy")
    dataArr_labels_train_hela=np.load(f"./training_data/labels_hela_REG.npy")
    ...
    class MonitorCallback(tflearn.callbacks.Callback):
        ...
        def on_epoch_end(self, training_state):
            ...
            if ((max(abs( self.maxtestSP_second))<abs(test_SPEAR_Corrval))):
                model.save(f"{save_location}/regModel/hela/BestModel/ClassificationModel.tfl")
            ...
            df.to_csv(f"{save_location}/statistical_measures/hela/REGAccuracies.csv")
        ...
        def on_train_end(self,training_state):
            ...
            df.to_csv(f"{save_location}/statistical_measures/hela/FinalREGAccuracies.csv")
    ...
    # save the model
    model.save(f"{save_location}/regModel/hela/finalModel/RegressionModel.tfl")
