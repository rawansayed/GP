...
def scenario6(epochNum):
    # --------------- loading Data --------------- #
    files = ['hela.episgt','hct116.episgt','hl60.episgt']
    ...
    dataArr_inputs_train_hek293t=np.load(f"./training_data/inputs_hek293t_REG.npy")
    dataArr_labels_train_hek293t=np.load(f"./training_data/labels_hek293t_REG.npy")
    ...
    class MonitorCallback(tflearn.callbacks.Callback):
        ...
        def on_epoch_end(self, training_state):
            ...
            df.to_csv(f"{save_location}/statistical_measures/hek/REGAccuracies.csv")
        ...
        def on_train_end(self,training_state):
            ...
            df.to_csv(f"{save_location}/statistical_measures/hek/FinalREGAccuracies.csv")
