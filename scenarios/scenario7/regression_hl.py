...
def scenario6(epochNum):
    # --------------- loading Data --------------- #
    files = ['hek293t.episgt','hela.episgt','hct116.episgt']
    ...
    dataArr_inputs_train_hl60=np.load(f"./training_data/inputs_hl60_REG.npy")
    dataArr_labels_train_hl60=np.load(f"./training_data/labels_hl60_REG.npy")
    ...
    class MonitorCallback(tflearn.callbacks.Callback):
        ...
        def on_epoch_end(self, training_state):
            ...
            if ((abs(max( self.maxtestSP_second))<abs(test_SPEAR_Corrval))):
                model.save(f"{save_location}/regModel/hl/BestModel/ClassificationModel.tfl")
            ...
            df.to_csv(f"{save_location}/statistical_measures/hl/REGAccuracies.csv")
        ...
        def on_train_end(self,training_state):
            ...
            df.to_csv(f"{save_location}/statistical_measures/hl/FinalREGAccuracies.csv")
    ...
    # save the model
    model.save(f"{save_location}/regModel/hl/finalModel/RegressionModel.tfl")
