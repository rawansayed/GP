...
# sess = tf.InteractiveSession()
# on_target_model_dir = 'deepcrispr/trained_models/ontar_ptaug_cnn'
...
# x = np.expand_dims(x, axis=2)  # shape(x) = [100, 8, 1, 23]
# sess = tf.InteractiveSession()
# on_target_model_dir = 'deepcrispr/trained_models/ontar_pt_cnn_reg'
...
# x_off = np.expand_dims(x_off, axis=2)  # shape(x) = [100, 8, 1, 23]
# sess = tf.InteractiveSession()
# off_target_model_dir = 'deepcrispr/trained_models/offtar_pt_cnn_reg'
