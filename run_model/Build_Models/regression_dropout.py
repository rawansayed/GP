...
def create_regression_model_with_dropout():
    ...
    REG = dropout(REG,0.7,name=f'encoder_Dropout_0')
    ...
    REG = dropout(REG,0.7,name=f'encoder_Dropout_1')
    # end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'encoder_Dropout_2')
    # end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'encoder_Dropout_3')
    # end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'encoder_Dropout_4')
    # end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'reg_Dropout_0')
    #end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'reg_Dropout_1')
    #end each layer with relu activation layer
    ...
    REG = dropout(REG,0.7,name=f'reg_Dropout_2')
    #end each layer with relu activation layer
