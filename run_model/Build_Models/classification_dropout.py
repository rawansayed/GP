...
def create_classification_model_with_dropout():
    ...
    CLS = dropout(CLS,0.7,name=f'encoder_Dropout_0')
    ...
    CLS = dropout(CLS,0.7,name=f'encoder_Dropout_1')
    # end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'encoder_Dropout_2')
    # end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'encoder_Dropout_3')
    # end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'encoder_Dropout_4')
    # end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'cls_Dropout_0')
    #end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'cls_Dropout_1')
    #end each layer with relu activation layer
    ...
    CLS = dropout(CLS,0.7,name=f'cls_Dropout_2')
    #end each layer with relu activation layer
