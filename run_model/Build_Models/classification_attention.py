...
def create_classification_model_with_attention():
    ...
    CLS = attention(CLS,encoder_channel_size[0],name = f"encoder_attention_0")
    ...
    CLS = attention(CLS,encoder_channel_size[1],name = f"encoder_attention_1")
    # end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[2],name = f"encoder_attention_2")
    # end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[3],name = f"encoder_attention_3")
    # end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[4],name = f"encoder_attention_4")
    # end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[0],name=f"cls_attention_0")
    #end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[1],name=f"cls_attention_1")
    #end each layer with relu activation layer
    ...
    CLS = attention(CLS,encoder_channel_size[2],name=f"cls_attention_2")
    #end each layer with relu activation layer
